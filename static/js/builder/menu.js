...
import { animationInDom, animationOutDom, animationMenuToCross, animationCrossToMenu } from '../action/page.js';
...
function buildMenuContainer() {
    ...
    let patchContainer = buildPatchContainer();
